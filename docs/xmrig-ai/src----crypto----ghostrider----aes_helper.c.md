...
static const sph_u32 AES1[256] = {
    ...
    # 创建 AESx 对象并传入参数 0x434386C5
    AESx(0x434386C5), 
    # 创建 AESx 对象并传入参数 0x4D4D9AD7
    AESx(0x4D4D9AD7), 
    # 创建 AESx 对象并传入参数 0x33336655
    AESx(0x33336655), 
    # 创建 AESx 对象并传入参数 0x85851194
    AESx(0x85851194),
    # 创建 AESx 对象并传入参数 0x45458ACF
    AESx(0x45458ACF), 
    # 创建 AESx 对象并传入参数 0xF9F9E910
    AESx(0xF9F9E910), 
    # 创建 AESx 对象并传入参数 0x02020406
    AESx(0x02020406), 
    # 创建 AESx 对象并传入参数 0x7F7FFE81
    AESx(0x7F7FFE81),
    # 创建 AESx 对象并传入参数 0x5050A0F0
    AESx(0x5050A0F0), 
    # 创建 AESx 对象并传入参数 0x3C3C7844
    AESx(0x3C3C7844), 
    # 创建 AESx 对象并传入参数 0x9F9F25BA
    AESx(0x9F9F25BA), 
    # 创建 AESx 对象并传入参数 0xA8A84BE3
    AESx(0xA8A84BE3),
    # 创建 AESx 对象并传入参数 0x5151A2F3
    AESx(0x5151A2F3), 
    # 创建 AESx 对象并传入参数 0xA3A35DFE
    AESx(0xA3A35DFE), 
    # 创建 AESx 对象并传入参数 0x404080C0
    AESx(0x404080C0), 
    # 创建 AESx 对象并传入参数 0x8F8F058A
    AESx(0x8F8F058A),
    # 创建 AESx 对象并传入参数 0x92923FAD
    AESx(0x92923FAD), 
    # 创建 AESx 对象并传入参数 0x9D9D21BC
    AESx(0x9D9D21BC), 
    # 创建 AESx 对象并传入参数 0x38387048
    AESx(0x38387048), 
    # 创建 AESx 对象并传入参数 0xF5F5F104
    AESx(0xF5F5F104),
    # 创建 AESx 对象并传入参数 0xBCBC63DF
    AESx(0xBCBC63DF), 
    # 创建 AESx 对象并传入参数 0xB6B677C1
    AESx(0xB6B677C1), 
    # 创建 AESx 对象并传入参数 0xDADAAF75
    AESx(0xDADAAF75), 
    # 创建 AESx 对象并传入参数 0x21214263
    AESx(0x21214263),
    # 创建 AESx 对象并传入参数 0x10102030
    AESx(0x10102030), 
    # 创建 AESx 对象并传入参数 0xFFFFE51A
    AESx(0xFFFFE51A), 
    # 创建 AESx 对象并传入参数 0xF3F3FD0E
    AESx(0xF3F3FD0E), 
    # 创建 AESx 对象并传入参数 0xD2D2BF6D
    AESx(0xD2D2BF6D),
    # 创建 AESx 对象并传入参数 0xCDCD814C
    AESx(0xCDCD814C), 
    # 创建 AESx 对象并传入参数 0x0C0C1814
    AESx(0x0C0C1814), 
    # 创建 AESx 对象并传入参数 0x13132635
    AESx(0x13132635), 
    # 创建 AESx 对象并传入参数 0xECECC32F
    AESx(0xECECC32F),
    # 创建 AESx 对象并传入参数 0x5F5FBEE1
    AESx(0x5F5FBEE1), 
    # 创建 AESx 对象并传入参数 0x979735A2
    AESx(0x979735A2), 
    # 创建 AESx 对象并传入参数 0x444488CC
    AESx(0x444488CC), 
    # 创建 AESx 对象并传入参数 0x17172E39
    AESx(0x17172E39),
    # 创建 AESx 对象并传入参数 0xC4C49357
    AESx(0xC4C49357), 
    # 创建 AESx 对象并传入参数 0xA7A755F2
    AESx(0xA7A755F2), 
    # 创建 AESx 对象并传入参数 0x7E7EFC82
    AESx(0x7E7EFC82), 
    # 创建 AESx 对象并传入参数 0x3D3D7A47
    AESx(0x3D3D7A47),
    # 创建 AESx 对象并传入参数 0x6464C8AC
    AESx(0x6464C8AC), 
    # 创建 AESx 对象并传入参数 0x5D5DBAE7
    AESx(0x5D5DBAE7), 
    # 创建 AESx 对象并传入参数 0x1919322B
    AESx(0x1919322B), 
    # 创建 AESx 对象并传入参数 0x7373E695
    AESx(0x7373E695),
    # 创建 AESx 对象并传入参数 0x6060C0A0
    AESx(0x6060C0A0), 
    # 创建 AESx 对象并传入参数 0x81811998
    AESx(0x81811998), 
    # 创建 AESx 对象并传入参数 0x4F4F9ED1
    AESx(0x4F4F9ED1), 
    # 创建 AESx 对象并传入参数 0xDCDCA37F
    AESx(0xDCDCA37F),
    # 创建 AESx 对象并传入参数 0x22224466
    AESx(0x22224466), 
    # 创建 AESx 对象并传入参数 0x2A2A547E
    AESx(0x2A2A547E), 
    # 创建 AESx 对象并传入参数 0x90903BAB
    AESx(0x90903BAB), 
    # 创建 AESx 对象并传入参数 0x88880B83
    AESx(0x88880B83),
    # 创建 AESx 对象并传入参数 0x46468CCA
    AESx(0x46468CCA), 
    # 创建 AESx 对象并传入参数 0xEEEEC729
    AESx(0xEEEEC729), 
    # 创建 AESx 对象并传入参数 0xB8B86BD3
    AESx(0xB8B86BD3), 
    # 创建 AESx 对象并传入参数 0x1414283C
    AESx(0x1414283C),
    # 创建 AESx 对象并传入参数 0xDEDEA779
    AESx(0xDEDEA779), 
    # 创建 AESx 对象并传入参数 0x5E5EBCE2
    AESx(0x5E5EBCE2), 
    # 创建 AESx 对象并传入参数 0x0B0B161D
    AESx(0x0B0B161D), 
    # 创建 AESx 对象并传入参数 0xDBDBAD76
    AESx(0xDBDBAD76),
    # 创建 AESx 对象并传入参数 0xE0E0DB3B
    AESx(0xE0E0DB3B), 
    # 创建 AESx 对象并传入参数 0x32326456
    AESx(0x32326456), 
    # 创建 AESx 对象并传入参数 0x3A3A744E
    AESx(0x3A3A744E), 
    # 创建 AESx 对象并传入参数 0x0A0A141E
    AESx(0x0A0A141E),
    # 创建 AESx 对象并传入参数 0x494992DB
    AESx(0x494992DB), 
    # 创建 AESx 对象并传入参数 0x06060C0A
    AESx(0x06060C0A), 
    # 创建 AESx 对象并传入参数 0x2424486C
    AESx(0x2424486C), 
    # 创建 AESx 对象并传入参数 0x5C5CB8E4
    AESx(0x5C5CB8E4),
    # 创建 AESx 对象并传入参数 0xC2C29F5D
    AESx(0xC2C29F5D), 
    # 创建 AESx 对象并传入参数 0xD3D3BD6E
    AESx(0xD3D3BD6E), 
    # 创建 AESx 对象并传入参数 0xACAC43EF
    AESx(0xACAC43EF), 
    # 创建 AESx 对象并传入参数 0x6262C4A6
    AESx(0x6262C4A6),
    # 创建 AESx 对象并传入参数 0x919139A8
    AESx(0x919139A8), 
    # 创建 AESx 对象并传入参数 0x959531A4
    AESx(0x959531A4), 
    # 创建 AESx 对象并传入参数 0xE4E4D337
    AESx(0xE4E4D337), 
    # 创建 AESx 对象并传入参数 0x7979F28B
    AESx(0x7979F28B),
    # 创建 AESx 对象并传入参数 0xE7E7D532
    AESx(0xE7E7D532), 
    # 创建 AESx 对象并传入参数 0xC8C88B43
    AESx(0xC8C88B43), 
    # 创建 AESx 对象并传入参数 0x37376E59
    AESx(0x37376E59), 
    # 创建 AESx 对象并传入参数 0x6D6DDAB7
    AESx(0x6D6DDAB7),
    # 创建 AESx 对象并传入参数 0x8D8D018C
    AESx(0x8D8D018C), 
    # 创建 AESx 对象并传入参数 0xD5D5B164
    AESx(0xD5D5B164), 
    # 创建 AESx 对象并传入参数 0x4E4E9CD2
    AESx(0x4E4E9CD2), 
    # 创建 AESx 对象并传入参数 0xA9A949E0
    AESx(0xA9A949E0),
    # 创建 AESx 对象并传入参数 0x6C6CD8B4
    AESx(0x6C6CD8B4), 
    # 创建 AESx 对象并传入参数 0x5656ACFA
    AESx(0x5656ACFA), 
    # 创建 AESx 对象并传入参数 0xF4F4F307
    AESx(0xF4F4F307), 
    # 创建 AESx 对象并传入参数 0xEAEACF25
    AESx(0xEAEACF25),
    # 创建 AESx 对象并传入参数 0x6565CAAF
    AESx(0x6565CAAF), 
    # 创建 AESx 对象并传入参数 0x7A7AF48E
    AESx(0x7A7AF48E), 
    # 创建 AESx 对象并传入参数 0xAEAE47E9
    AESx(0xAEAE47E9), 
    # 创建 AESx 对象并传入参数 0x08081018
    AESx(0x08081018),
    # 创建 AESx 对象并传入参数 0xBABA6FD5
    AESx(0xBABA6FD5), 
    # 创建 AESx 对象并传入参数 0x7878F088
    AESx(0x7878F088), 
    # 创建 AESx 对象并传入参数 0x25254A6F
    AESx(0x25254A6F), 
    # 创建 AESx 对象并传入参数 0x2E2E5C72
    AESx(0x2E2E5C72),
    # 创建 AESx 对象并传入参数 0x1C1C3824
    AESx(0x1C1C3824), 
    # 创建 AESx 对象并传入参数 0xA6A657F1
    AESx(0xA6A657F1), 
    # 创建 AESx 对象并传入参数 0xB4B473C7
    AESx(0xB4B473C7), 
    # 创建 AESx 对象并传入参数 0xC6C69751
    AESx(0xC6C69751),
    # 创建 AESx 对象并传入参数 0xE8E8CB23
    AESx(0xE8E8CB23), 
    # 创建 AESx 对象并传入参数 0xDDDDA17C
    AESx(0xDDDDA17C), 
    # 创建 AESx 对象并传入参数 0x7474E89C
    AESx(0x7474E89C), 
    # 创建 AESx 对象并传入参数 0x1F1F3E21
    AESx(0x1F1F3E21),
    # 创建 AESx 对象并传入参数
...
// 定义一个静态的无符号32位整数数组AES2，包含256个元素
...
// 定义一个静态的无符号32位整数数组 AES3，包含256个元素
static const sph_u32 AES3[256] = {
    // 使用 AESx 宏定义的值初始化数组元素
    ...
    # 使用AESx函数对0x86C54343进行加密
    AESx(0x86C54343), 
    # 使用AESx函数对0x9AD74D4D进行加密
    AESx(0x9AD74D4D), 
    # 使用AESx函数对0x66553333进行加密
    AESx(0x66553333), 
    # 使用AESx函数对0x11948585进行加密
    AESx(0x11948585),
    # 使用AESx函数对0x8ACF4545进行加密
    AESx(0x8ACF4545), 
    # 使用AESx函数对0xE910F9F9进行加密
    AESx(0xE910F9F9), 
    # 使用AESx函数对0x04060202进行加密
    AESx(0x04060202), 
    # 使用AESx函数对0xFE817F7F进行加密
    AESx(0xFE817F7F),
    # 使用AESx函数对0xA0F05050进行加密
    AESx(0xA0F05050), 
    # 使用AESx函数对0x78443C3C进行加密
    AESx(0x78443C3C), 
    # 使用AESx函数对0x25BA9F9F进行加密
    AESx(0x25BA9F9F), 
    # 使用AESx函数对0x4BE3A8A8进行加密
    AESx(0x4BE3A8A8),
    # 使用AESx函数对0xA2F35151进行加密
    AESx(0xA2F35151), 
    # 使用AESx函数对0x5DFEA3A3进行加密
    AESx(0x5DFEA3A3), 
    # 使用AESx函数对0x80C04040进行加密
    AESx(0x80C04040), 
    # 使用AESx函数对0x058A8F8F进行加密
    AESx(0x058A8F8F),
    # 使用AESx函数对0x3FAD9292进行加密
    AESx(0x3FAD9292), 
    # 使用AESx函数对0x21BC9D9D进行加密
    AESx(0x21BC9D9D), 
    # 使用AESx函数对0x70483838进行加密
    AESx(0x70483838), 
    # 使用AESx函数对0xF104F5F5进行加密
    AESx(0xF104F5F5),
    # 使用AESx函数对0x63DFBCBC进行加密
    AESx(0x63DFBCBC), 
    # 使用AESx函数对0x77C1B6B6进行加密
    AESx(0x77C1B6B6), 
    # 使用AESx函数对0xAF75DADA进行加密
    AESx(0xAF75DADA), 
    # 使用AESx函数对0x42632121进行加密
    AESx(0x42632121),
    # 使用AESx函数对0x20301010进行加密
    AESx(0x20301010), 
    # 使用AESx函数对0xE51AFFFF进行加密
    AESx(0xE51AFFFF), 
    # 使用AESx函数对0xFD0EF3F3进行加密
    AESx(0xFD0EF3F3), 
    # 使用AESx函数对0xBF6DD2D2进行加密
    AESx(0xBF6DD2D2),
    # 使用AESx函数对0x814CCDCD进行加密
    AESx(0x814CCDCD), 
    # 使用AESx函数对0x18140C0C进行加密
    AESx(0x18140C0C), 
    # 使用AESx函数对0x26351313进行加密
    AESx(0x26351313), 
    # 使用AESx函数对0xC32FECEC进行加密
    AESx(0xC32FECEC),
    # 使用AESx函数对0xBEE15F5F进行加密
    AESx(0xBEE15F5F), 
    # 使用AESx函数对0x35A29797进行加密
    AESx(0x35A29797), 
    # 使用AESx函数对0x88CC4444进行加密
    AESx(0x88CC4444), 
    # 使用AESx函数对0x2E391717进行加密
    AESx(0x2E391717),
    # 使用AESx函数对0x9357C4C4进行加密
    AESx(0x9357C4C4), 
    # 使用AESx函数对0x55F2A7A7进行加密
    AESx(0x55F2A7A7), 
    # 使用AESx函数对0xFC827E7E进行加密
    AESx(0xFC827E7E), 
    # 使用AESx函数对0x7A473D3D进行加密
    AESx(0x7A473D3D),
    # 使用AESx函数对0xC8AC6464进行加密
    AESx(0xC8AC6464), 
    # 使用AESx函数对0xBAE75D5D进行加密
    AESx(0xBAE75D5D), 
    # 使用AESx函数对0x322B1919进行加密
    AESx(0x322B1919), 
    # 使用AESx函数对0xE6957373进行加密
    AESx(0xE6957373),
    # 使用AESx函数对0xC0A06060进行加密
    AESx(0xC0A06060), 
    # 使用AESx函数对0x19988181进行加密
    AESx(0x19988181), 
    # 使用AESx函数对0x9ED14F4F进行加密
    AESx(0x9ED14F4F), 
    # 使用AESx函数对0xA37FDCDC进行加密
    AESx(0xA37FDCDC),
    # 使用AESx函数对0x44662222进行加密
    AESx(0x44662222), 
    # 使用AESx函数对0x547E2A2A进行加密
    AESx(0x547E2A2A), 
    # 使用AESx函数对0x3BAB9090进行加密
    AESx(0x3BAB9090), 
    # 使用AESx函数对0x0B838888进行加密
    AESx(0x0B838888),
    # 使用AESx函数对0x8CCA4646进行加密
    AESx(0x8CCA4646), 
    # 使用AESx函数对0xC729EEEE进行加密
    AESx(0xC729EEEE), 
    # 使用AESx函数对0x6BD3B8B8进行加密
    AESx(0x6BD3B8B8), 
    # 使用AESx函数对0x283C1414进行加密
    AESx(0x283C1414),
    # 使用AESx函数对0xA779DEDE进行加密
    AESx(0xA779DEDE), 
    # 使用AESx函数对0xBCE25E5E进行加密
    AESx(0xBCE25E5E), 
    # 使用AESx函数对0x161D0B0B进行加密
    AESx(0x161D0B0B), 
    # 使用AESx函数对0xAD76DBDB进行加密
    AESx(0xAD76DBDB),
    # 使用AESx函数对0xDB3BE0E0进行加密
    AESx(0xDB3BE0E0), 
    # 使用AESx函数对0x64563232进行加密
    AESx(0x64563232), 
    # 使用AESx函数对0x744E3A3A进行加密
    AESx(0x744E3A3A), 
    # 使用AESx函数对0x141E0A0A进行加密
    AESx(0x141E0A0A),
    # 使用AESx函数对0x92DB4949进行加密
    AESx(0x92DB4949), 
    # 使用AESx函数对0x0C0A0606进行加密
    AESx(0x0C0A0606), 
    # 使用AESx函数对0x486C2424进行加密
    AESx(0x486C2424), 
    # 使用AESx函数对0xB8E45C5C进行加密
    AESx(0xB8E45C5C),
    # 使用AESx函数对0x9F5DC2C2进行加密
    AESx(0x9F5DC2C2), 
    # 使用AESx函数对0xBD6ED3D3进行加密
    AESx(0xBD6ED3D3), 
    # 使用AESx函数对0x43EFACAC进行加密
    AESx(0x43EFACAC), 
    # 使用AESx函数对0xC4A66262进行加密
    AESx(0xC4A66262),
    # 使用AESx函数对0x39A89191进行加密
    AESx(0x39A89191), 
    # 使用AESx函数对0x31A49595进行加密
    AESx(0x31A49595), 
    # 使用AESx函数对0xD337E4E4进行加密
    AESx(0xD337E4E4), 
    # 使用AESx函数对0xF28B7979进行加密
    AESx(0xF28B7979),
    # 使用AESx函数对0xD532E7E7进行加密
    AESx(0xD532E7E7), 
    # 使用AESx函数对0x8B43C8C8进行加密
    AESx(0x8B43C8C8), 
    # 使用AESx函数对0x6E593737进行加密
    AESx(0x6E593737), 
    # 使用AESx函数对0xDAB76D6D进行加密
    AESx(0xDAB76D6D),
    # 使用AESx函数对0x018C8D8D进行加密
    AESx(0x018C8D8D), 
    # 使用AESx函数对0xB164D5D5进行加密
    AESx(0xB164D5D5), 
    # 使用AESx函数对0x9CD24E4E进行加密
    AESx(0x9CD24E4E), 
    # 使用AESx函数对0x49E0A9A9进行加密
    AESx(0x49E0A9A9),
    # 使用AESx函数对0xD8B46C6C进行加密
    AESx(0xD8B46C6C), 
    # 使用AESx函数对0xACFA5656进行加密
    AESx(0xACFA5656), 
    # 使用AESx函数对0xF307F4F4进行加密
    AESx(0xF307F4F4), 
    # 使用AESx函数对0xCF25EAEA进行加密
    AESx(0xCF25EAEA),
    # 使用AESx函数对0xCAAF6565进行加密
    AESx(0xCAAF6565), 
    # 使用AESx函数对0xF48E7A7A进行加密
    AESx(0xF48E7A7A), 
    # 使用AESx函数对0x47E9AEAE进行加密
    AESx(0x47E9AEAE), 
    # 使用AESx函数对0x10180808进行加密
    AESx(0x10180808),
    # 使用AESx函数对0x6FD5BABA进行加密
    AESx(0x6FD5BABA), 
    # 使用AESx函数对0xF0887878进行加密
    AESx(0xF0887878), 
    # 使用AESx函数对0x4A6F2525进行加密
    AESx(0x4A6F2525), 
    # 使用AESx函数对0x5C722E2E进行加密
    AESx(0x5C722E2E),
    # 使用AESx函数对0x38241C1C进行加密
    AESx(0x38241C1C), 
    # 使用AESx函数对0x57F1A6A6进行加密
    AESx(0x57F1A6A6), 
    # 使用AESx函数对0x73C7B4B4进行加密
    AESx(0x73C7B4B4), 
    # 使用AESx函数对0x9751C6C6进行加密
    AESx(0x9751C6C6),
    # 使用AESx函数对0xCB23E8E8进行加密
    AESx(0xCB23E8E8), 
    # 使用AESx函数对0xA17CDDDD进行加密
    AESx(0xA17CDDDD), 
    # 使用AESx函数对0xE89C7474进行加密
    AESx(0xE89C7474), 
    # 使用AESx函数对0x3E211F1F进行加密
    AESx(0x3E211F1F),
    # 创建 AESx 对象并传入十六进制参数
