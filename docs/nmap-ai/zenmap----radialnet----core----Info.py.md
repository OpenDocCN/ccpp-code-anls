# `nmap\zenmap\radialnet\core\Info.py`
...
# 本程序根据 Nmap 公共源代码许可证（NPSL）的条款分发。适用于特定 Nmap 版本或源代码控制修订版本的确切许可证文本包含在该版本的 Nmap 或源代码控制修订版本的 LICENSE 文件中。有关更多 Nmap 版权/法律信息，请访问 https://nmap.org/book/man-legal.html，有关 NPSL 许可证本身的更多信息，请访问 https://nmap.org/npsl/。本标题总结了 Nmap 许可证的一些关键点，但不能替代实际的许可证文本。
...
# 定义一个包含软件信息的字典
INFO = {'name': 'RadialNet',  # 软件名称
        'version': '0.44',  # 软件版本
        'website': 'http://www.dca.ufrn.br/~joaomedeiros/radialnet/',  # 软件网站
        'authors': ['João Paulo de Souza Medeiros'],  # 软件作者
        'copyright': 'Copyright (C) 2007, 2008 Insecure.Com LLC'}  # 版权信息
```